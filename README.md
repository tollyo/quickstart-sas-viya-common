...
After that, everything will be driving by a number of playbooks executed from the ansible controller.
...
The playbook ````playbooks\predeployment.yml```` does all additional steps needed before installing SAS, including
- host routing
- volume attachments
- setting up directories and users 
- executing VIRK for all other deployment prereqs (ulimits, default users...)
